...
class Everything:
    def __init__(self):
        ...
        self.everything_dll = ctypes.WinDLL (".\\EverythingSDK\\DLL\\Everything64.dll")
    ...
    def search(self, word):
        #setup search
        self.everything_dll.Everything_SetSearchW(word)
        ...
        for i in range(num_results):
            ...
            #print("Filename: {}\nDate Modified: {}\nSize: {} bytes\n".format(ctypes.wstring_at(filename),self.get_time(date_modified_filetime),file_size.value))
            filenamepy = ctypes.wstring_at(filename)
            filenames.append(filenamepy)
